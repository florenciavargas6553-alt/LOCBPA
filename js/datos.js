...
const locbgae = [
    ...
    },
    {
        ...
        parrafoTitulo: "De la declaración de intereses", 
        titulo: "💮",
        texto: "La declaración de intereses deberá contener la individualización de las actividades profesionales y económicas en que participe la autoridad o el funcionario.",
        conceptos: ["."],
    },
    {
        numero: "61",
    ...
    },
    {
        ...
        parrafoTitulo: "De la declaración de intereses", 
        titulo: "💮",
        texto: " Un reglamento establecerá los requisitos de las declaraciones de intereses y contendrá las demás normas necesarias para dar cumplimiento a las disposiciones de este párrafo.",
        conceptos: ["."],
    },
    {
        numero: "63",
        ...
        capituloTitulo: "De la probidad administrativa",
        parrafo: "Párrafo 4º",            
        parrafoTitulo: "De la responsabilidad y de las sanciones", 
        titulo: "💮",
        texto: " Las reparticiones encargadas del control interno en los órganos u organismos de la Administración del Estado tendrán la obligación de velar por la observancia de las normas de este Título, sin perjuicio de las atribuciones de la Contraloría General de la República.\nLa infracción a las conductas exigibles prescritas en este Título hará incurrir en responsabilidad y traerá consigo las sanciones que determine la ley. La responsabilidad administrativa se hará efectiva con sujeción a las normas estatutarias que rijan al órgano u organismo en que se produjo la infracción.",
        conceptos: ["."],
    },
    {
        numero: "64",
        ...
        parrafoTitulo: "De la responsabilidad y de las sanciones", 
        titulo: "💮",
        texto: "Contravienen especialmente el principio de la probidad administrativa, las siguientes conductas:",
         numerales: [
            ...
            "5.Solicitar, hacerse prometer o aceptar, en razón del cargo o función, para sí o para terceros, donativos, ventajas o privilegios de cualquier naturaleza.\nExceptúanse de esta prohibición los donativos oficiales y protocolares, y aquellos que autoriza la costumbre como manifestaciones de cortesía y buena educación.\nEl millaje u otro beneficio similar que otorguen las líneas aéreas por vuelos nacionales o internacionales a los que viajen como autoridades o funcionarios, y que sean financiados con recursos públicos, no podrán ser utilizados en actividades o viajes particulares;"
             ...
             "7. Contravenir los deberes de eficiencia, eficacia y legalidad que rigen el desempeño de los cargos públicos, con grave entorpecimiento del servicio o del ejercicio de los derechos ciudadanos ante la Administración."
        ],
        conceptos: ["."],
    },
    {
    ...
    },
    {
        ...
        parrafoTitulo: "De la responsabilidad y de las sanciones", 
        titulo: "💮",
        texto: "La inclusión de datos relevantes inexactos y la omisión inexcusable de la información relevante requerida por la ley en la declaración de intereses se sancionarán administrativamente con la medida disciplinaria de destitución.",
        conceptos: ["."],
    },
    {
        numero: "69",
        ...
        parrafoTitulo: "De la responsabilidad y de las sanciones", 
        titulo: "💮",
        texto: "Las declaraciones de inhabilidad y de intereses se considerarán documentos públicos o auténticos.",
        conceptos: ["."],
    },
    {
        numero: "70",
